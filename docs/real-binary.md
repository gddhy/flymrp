...
当前：platEx 1204 SWITCHPATH **REAL_EXECUTED**。生产停在 `table[122]` `DrawRect(0,0,0,0,0,0,0)`。`arm_ext_call(0)` / Lua 未恢复。Stage 5-C **NOT COMPLETE**。见 `docs/autonomous-progress.md`。  
