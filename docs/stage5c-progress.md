...
| A | 29 | 冻结（5-B） |
| B | 26 | 冻结（5-B） |
| C | 32 | 上表 + `mr_table/0`、`mr_table/14`、`mr_table/125`、`mr_table/130/7`、`mr_table/38/0x4c6`、`mr_table/33/mr_getTime`、`mr_table/17/sprintf/%d`、`mr_table/100/pack_filename`、`mr_table/40/current-pack/RDONLY`、`mr_table/44/read`、`mr_table/45/seek`、`mr_table/41/close` |
