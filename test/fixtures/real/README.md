...
**real-app green: false。** guest inflate 完成；table[30]/[37]/[26]/[42]/[49]/[5] REAL_EXECUTED；`arm_ext_call(0)` / Lua 未恢复。生产停在 `table[35]` `mr_getUserInfo`。Stage 5-C **NOT COMPLETE**。见 `docs/autonomous-progress.md`。
