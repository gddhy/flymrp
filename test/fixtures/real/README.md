...
**real-app green: false。** guest inflate 完成；table[30]/[37]/[26]/[42] REAL_EXECUTED；`arm_ext_call(0)` / Lua 未恢复。生产停在 `table[49]` `mr_mkDir`（LIVE `gsidbak`）。Stage 5-C **NOT COMPLETE**。见 `docs/autonomous-progress.md`。
