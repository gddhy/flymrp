...
**real-app green: false。** guest inflate 完成；platEx 1204 SWITCHPATH REAL_EXECUTED；`arm_ext_call(0)` / Lua 未恢复。生产停在 `table[122]` `DrawRect`。Stage 5-C **NOT COMPLETE**。见 `docs/autonomous-progress.md`。
