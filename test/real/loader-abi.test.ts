...
describe("5-C.5 real loader chain", () => {
  it("cfunction load + code 6 return, then stops at table[33]", () => {
    ...
    expect(rt.unknownRequiredSlot).toBe(33);
    expect(rt.unknownEvents.some((e) => e.family === "mr_table" && e.code === 33)).toBe(true);
