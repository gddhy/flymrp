...
describe("5-C.10Q forensic ARM insn watchdog", () => {
  it("production default is a finite 64M watchdog, not a slice", () => {
    expect(DEFAULT_INSN_BUDGET).toBe(64_000_000);
    expect(MAX_INSN_BUDGET).toBe(64_000_000);
  ...
  it("low forensic budget hits ARM_INSN_BUDGET at the 1M landmark", () => {
    ...
    expect(r.productionDefaultBudget).toBe(64_000_000);
