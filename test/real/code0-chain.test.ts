...
describe("5-C.8 mrc_init successor BLX / mr_table", () => {
  it("after REAL_EXECUTED table[130], table[38] platEx runs; next unknown is table[9]; 0x01ea9254 is not reached", () => {
    ...
    expect(r.code0Slots).toEqual([130, 14, 38, 33, 17, 40, 14, 44, 0, 45, 44, 0, 3, 3, 10, 3, 3, 10, 3, 3, 10, 3, 3, 1, 1, 0, 45, 44, 41, 9]);
