...
describe("5-C.8 mrc_init successor BLX / mr_table", () => {
  it("after REAL_EXECUTED table[130], table[38] platEx runs; memcmp2 executes; 0x01ea9254 is not reached", () => {
    ...
    expect(r.productionThrown).toBe(UNKNOWN_SLOT_32_THROWN);
    expect(r.probeThrown).toBe(UNKNOWN_SLOT_32_THROWN);
    ...
    expect(r.code0Slots.at(-1)).toBe(32);
