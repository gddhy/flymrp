...
当前：guest inflate 完成；platEx 1204 SWITCHPATH **REAL_EXECUTED**。`arm_ext_call(0)` / Lua 未恢复。Stage 5-C **NOT COMPLETE**（blocker=`table[122]` `DrawRect`）。见 `docs/autonomous-progress.md`。  
